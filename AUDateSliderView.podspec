#
#  Be sure to run `pod spec lint AUDateSliderView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of AUDateSliderView in Markdown format.
  ...
  s.source       = { :git => "https://github.com/piotrek21/AUDateSliderView", :tag => "0.0.2" }
